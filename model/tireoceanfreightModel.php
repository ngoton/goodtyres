...
Class tireoceanfreightModel Extends baseModel {
	protected $table = "tire_ocean_freight";
    ...
    public function deleteTire($id){
    	if ($this->getTire($id)) {
    		return $this->delete($this->table,array('tire_ocean_freight_id'=>$id));
    	}
    }
    ...
    public function getAllTireByWhere($id){
        return $this->query('SELECT * FROM tire_ocean_freight WHERE tire_ocean_freight_id != '.$id);
    }
