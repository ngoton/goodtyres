...
Class tirestuffModel Extends baseModel {
	protected $table = "tire_stuff";
    ...
    public function deleteTire($id){
    	if ($this->getTire($id)) {
    		return $this->delete($this->table,array('tire_stuff_id'=>$id));
    	}
    }
    ...
    public function getAllTireByWhere($id){
        return $this->query('SELECT * FROM tire_stuff WHERE tire_stuff_id != '.$id);
    }
