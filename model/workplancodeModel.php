...
Class workplancodeModel Extends baseModel {
	protected $table = "work_plan_code";
    ...
    public function deleteWork($id){
    	if ($this->getWork($id)) {
    		return $this->delete($this->table,array('work_plan_code_id'=>$id));
    	}
    }
    ...
    public function getAllWorkByWhere($id){
        return $this->query('SELECT * FROM work_plan_code WHERE work_plan_code_id != '.$id);
    }
