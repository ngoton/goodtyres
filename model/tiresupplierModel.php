...
Class tiresupplierModel Extends baseModel {
	protected $table = "tire_supplier";
    ...
    public function deleteTire($id){
    	if ($this->getTire($id)) {
    		return $this->delete($this->table,array('tire_supplier_id'=>$id));
    	}
    }
    ...
    public function getAllTireByWhere($id){
        return $this->query('SELECT * FROM tire_supplier WHERE tire_supplier_id != '.$id);
    }
