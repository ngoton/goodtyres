...
Class rentsaleModel Extends baseModel {
	protected $table = "rent_sale";
    ...
    public function deleteSale($id){
    	if ($this->getSale($id)) {
    		return $this->delete($this->table,array('rent_sale_id'=>$id));
    	}
    }
    ...
    public function getAllSaleByWhere($id){
        return $this->query('SELECT * FROM rent_sale WHERE rent_sale_id != '.$id);
    }
