...
Class importtirepriceModel Extends baseModel {
	protected $table = "import_tire_price";
    ...
    public function deleteImport($id){
    	if ($this->getImport($id)) {
    		return $this->delete($this->table,array('import_tire_price_id'=>$id));
    	}
    }
    ...
    public function getAllImportByWhere($id){
        return $this->query('SELECT * FROM import_tire_price WHERE import_tire_price_id != '.$id);
    }
