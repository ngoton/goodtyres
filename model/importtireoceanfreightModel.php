...
Class importtireoceanfreightModel Extends baseModel {
	protected $table = "import_tire_ocean_freight";
    ...
    public function deleteImport($id){
    	if ($this->getImport($id)) {
    		return $this->delete($this->table,array('import_tire_ocean_freight_id'=>$id));
    	}
    }
    ...
    public function getAllImportByWhere($id){
        return $this->query('SELECT * FROM import_tire_ocean_freight WHERE import_tire_ocean_freight_id != '.$id);
    }
