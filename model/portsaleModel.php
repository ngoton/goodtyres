...
Class portsaleModel Extends baseModel {
	protected $table = "port_sale";
    ...
    public function deleteSale($id){
    	if ($this->getSale($id)) {
    		return $this->delete($this->table,array('port_sale_id'=>$id));
    	}
    }
    ...
    public function getAllSaleByWhere($id){
        return $this->query('SELECT * FROM port_sale WHERE port_sale_id != '.$id);
    }
