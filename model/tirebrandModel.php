...
Class tirebrandModel Extends baseModel {
	protected $table = "tire_brand";
    ...
    public function deleteTire($id){
    	if ($this->getTire($id)) {
    		return $this->delete($this->table,array('tire_brand_id'=>$id));
    	}
    }
    ...
    public function getAllTireByWhere($id){
        return $this->query('SELECT * FROM tire_brand WHERE tire_brand_id != '.$id);
    }
