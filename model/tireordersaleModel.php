...
Class tireordersaleModel Extends baseModel {
	protected $table = "tire_order_sale";
    ...
    public function deleteTire($id){
    	if ($this->getTire($id)) {
    		return $this->delete($this->table,array('tire_order_sale_id'=>$id));
    	}
    }
    ...
    public function getAllTireByWhere($id){
        return $this->query('SELECT * FROM tire_order_sale WHERE tire_order_sale_id != '.$id);
    }
