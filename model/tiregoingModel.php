...
Class tiregoingModel Extends baseModel {
	protected $table = "tire_going";
    ...
    public function deleteTire($id){
    	if ($this->getTire($id)) {
    		return $this->delete($this->table,array('tire_going_id'=>$id));
    	}
    }
    ...
    public function getAllTireByWhere($id){
        return $this->query('SELECT * FROM tire_going WHERE tire_going_id != '.$id);
    }
