...
Class shipmentvendorModel Extends baseModel {
	protected $table = "shipment_vendor";
    ...
    public function deleteVendor($id){
    	if ($this->getVendor($id)) {
    		return $this->delete($this->table,array('shipment_vendor_id'=>$id));
    	}
    }
    ...
    public function getAllVendorByWhere($id){
        return $this->query('SELECT * FROM shipment_vendor WHERE shipment_vendor_id != '.$id);
    }
