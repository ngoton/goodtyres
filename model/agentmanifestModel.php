...
Class agentmanifestModel Extends baseModel {
	protected $table = "agent_manifest";
    ...
    public function deleteAgent($id){
    	if ($this->getAgent($id)) {
    		return $this->delete($this->table,array('agent_manifest_id'=>$id));
    	}
    }
    ...
    public function getAllAgentByWhere($id){
        return $this->query('SELECT * FROM agent_manifest WHERE agent_manifest_id != '.$id);
    }
