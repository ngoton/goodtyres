...
Class tirepricediscounteventModel Extends baseModel {
	protected $table = "tire_price_discount_event";
    ...
    public function deleteTire($id){
    	if ($this->getTire($id)) {
    		return $this->delete($this->table,array('tire_price_discount_event_id'=>$id));
    	}
    }
    ...
    public function getAllTireByWhere($id){
        return $this->query('SELECT * FROM tire_price_discount_event WHERE tire_price_discount_event_id != '.$id);
    }
