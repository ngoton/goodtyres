...
Class eatingallowanceModel Extends baseModel {
	protected $table = "eating_allowance";
    ...
    {    
        /*$data = array(
            ...
            'staff_eating' => $data['staff_eating'],
    ...
    public function deleteAllowance($id){
    	if ($this->getAllowance($id)) {
    		return $this->delete($this->table,array('eating_allowance_id'=>$id));
    	}
    }
    ...
    public function getAllAllowanceByWhere($id){
        return $this->query('SELECT * FROM eating_allowance WHERE eating_allowance_id != '.$id);
    }
