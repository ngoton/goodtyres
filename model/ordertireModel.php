...
Class ordertireModel Extends baseModel {
	protected $table = "order_tire";
    ...
    public function deleteTire($id){
    	if ($this->getTire($id)) {
    		return $this->delete($this->table,array('order_tire_id'=>$id));
    	}
    }
    ...
    public function getAllTireByWhere($id){
        return $this->query('SELECT * FROM order_tire WHERE order_tire_id != '.$id);
    }
