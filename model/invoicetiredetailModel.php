...
Class invoicetiredetailModel Extends baseModel {
	protected $table = "invoice_tire_detail";
    ...
    public function deleteInvoice($id){
    	if ($this->getInvoice($id)) {
    		return $this->delete($this->table,array('invoice_tire_detail_id'=>$id));
    	}
    }
    ...
    public function getAllInvoiceByWhere($id){
        return $this->query('SELECT * FROM invoice_tire_detail WHERE invoice_tire_detail_id != '.$id);
    }
