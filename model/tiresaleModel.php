...
Class tiresaleModel Extends baseModel {
	protected $table = "tire_sale";
    ...
    public function deleteTire($id){
    	if ($this->getTire($id)) {
    		return $this->delete($this->table,array('tire_sale_id'=>$id));
    	}
    }
    ...
    public function getAllTireByWhere($id){
        return $this->query('SELECT * FROM tire_sale WHERE tire_sale_id != '.$id);
    }
