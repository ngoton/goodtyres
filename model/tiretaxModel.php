...
Class tiretaxModel Extends baseModel {
	protected $table = "tire_tax";
    ...
    public function deleteTire($id){
    	if ($this->getTire($id)) {
    		return $this->delete($this->table,array('tire_tax_id'=>$id));
    	}
    }
    ...
    public function getAllTireByWhere($id){
        return $this->query('SELECT * FROM tire_tax WHERE tire_tax_id != '.$id);
    }
