...
Class contsaleModel Extends baseModel {
	protected $table = "cont_sale";
    ...
    public function deleteSale($id){
    	if ($this->getSale($id)) {
    		return $this->delete($this->table,array('cont_sale_id'=>$id));
    	}
    }
    ...
    public function getAllSaleByWhere($id){
        return $this->query('SELECT * FROM cont_sale WHERE cont_sale_id != '.$id);
    }
