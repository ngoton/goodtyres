...
Class tirepricediscountModel Extends baseModel {
	protected $table = "tire_price_discount";
    ...
    public function deleteTire($id){
    	if ($this->getTire($id)) {
    		return $this->delete($this->table,array('tire_price_discount_id'=>$id));
    	}
    }
    ...
    public function getAllTireByWhere($id){
        return $this->query('SELECT * FROM tire_price_discount WHERE tire_price_discount_id != '.$id);
    }
