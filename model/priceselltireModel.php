...
Class priceselltireModel Extends baseModel {
	protected $table = "price_sell_tire";
    ...
    public function deleteTire($id){
    	if ($this->getTire($id)) {
    		return $this->delete($this->table,array('price_sell_tire_id'=>$id));
    	}
    }
    ...
    public function getAllTireByWhere($id){
        return $this->query('SELECT * FROM price_sell_tire WHERE price_sell_tire_id != '.$id);
    }
