...
Class tiresellModel Extends baseModel {
	protected $table = "tire_sell";
    ...
    public function deleteTire($id){
    	if ($this->getTire($id)) {
    		return $this->delete($this->table,array('tire_sell_id'=>$id));
    	}
    }
    ...
    public function getAllTireByWhere($id){
        return $this->query('SELECT * FROM tire_sell WHERE tire_sell_id != '.$id);
    }
