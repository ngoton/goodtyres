...
Class curricularModel Extends baseModel {
    ...
    public function deleteSalary($id){
    	if ($this->getSalary($id)) {
    		return $this->delete($this->table,array('curricular_id'=>$id));
    	}
    }
    ...
    public function getAllSalaryByWhere($id){
        return $this->query('SELECT * FROM curricular WHERE curricular_id != '.$id);
    }
