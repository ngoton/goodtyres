...
Class tirequotationpatternModel Extends baseModel {
	protected $table = "tire_quotation_pattern";
    ...
    public function deleteTire($id){
    	if ($this->getTire($id)) {
    		return $this->delete($this->table,array('tire_quotation_pattern_id'=>$id));
    	}
    }
    ...
    public function getAllTireByWhere($id){
        return $this->query('SELECT * FROM tire_quotation_pattern WHERE tire_quotation_pattern_id != '.$id);
    }
