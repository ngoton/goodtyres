...
Class tirebrandregionModel Extends baseModel {
	protected $table = "tire_brand_region";
    ...
    public function deleteTire($id){
    	if ($this->getTire($id)) {
    		return $this->delete($this->table,array('tire_brand_region_id'=>$id));
    	}
    }
    ...
    public function getAllTireByWhere($id){
        return $this->query('SELECT * FROM tire_brand_region WHERE tire_brand_region_id != '.$id);
    }
