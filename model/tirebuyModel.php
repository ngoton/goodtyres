...
Class tirebuyModel Extends baseModel {
	protected $table = "tire_buy";
    ...
    public function deleteTire($id){
    	if ($this->getTire($id)) {
    		return $this->delete($this->table,array('tire_buy_id'=>$id));
    	}
    }
    ...
    public function getAllTireByWhere($id){
        return $this->query('SELECT * FROM tire_buy WHERE tire_buy_id != '.$id);
    }
