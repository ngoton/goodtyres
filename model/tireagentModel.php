...
Class tireagentModel Extends baseModel {
	protected $table = "tire_agent";
    ...
    public function deleteTire($id){
    	if ($this->getTire($id)) {
    		return $this->delete($this->table,array('tire_agent_id'=>$id));
    	}
    }
    ...
    public function getAllTireByWhere($id){
        return $this->query('SELECT * FROM tire_agent WHERE tire_agent_id != '.$id);
    }
