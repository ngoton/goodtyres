...
Class positionstaffevaluatevoteModel Extends baseModel {
	protected $table = "position_staff_evaluate_vote";
    ...
    public function deleteSalary($id){
    	if ($this->getSalary($id)) {
    		return $this->delete($this->table,array('position_staff_evaluate_vote_id'=>$id));
    	}
    }
