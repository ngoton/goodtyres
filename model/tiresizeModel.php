...
Class tiresizeModel Extends baseModel {
	protected $table = "tire_size";
    ...
    public function deleteTire($id){
    	if ($this->getTire($id)) {
    		return $this->delete($this->table,array('tire_size_id'=>$id));
    	}
    }
    ...
    public function getAllTireByWhere($id){
        return $this->query('SELECT * FROM tire_size WHERE tire_size_id != '.$id);
    }
