...
Class cargoorderModel Extends baseModel {
	protected $table = "cargo_order";
    ...
    public function deleteCargo($id){
    	if ($this->getCargo($id)) {
    		return $this->delete($this->table,array('cargo_order_id'=>$id));
    	}
    }
    ...
    public function getAllCargoByWhere($id){
        return $this->query('SELECT * FROM cargo_order WHERE cargo_order_id != '.$id);
    }
