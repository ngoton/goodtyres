...
Class ecustomerModel Extends baseModel {
	protected $table = "e_customer";
    ...
    public function deleteCustomer($id){
    	if ($this->getCustomer($id)) {
    		return $this->delete($this->table,array('e_customer_id'=>$id));
    	}
    }
    ...
    public function getAllCustomerByWhere($id){
        return $this->query('SELECT * FROM e_customer WHERE e_customer_id != '.$id);
    }
