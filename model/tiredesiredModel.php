...
Class tiredesiredModel Extends baseModel {
	protected $table = "tire_desired";
    ...
    public function deleteTire($id){
    	if ($this->getTire($id)) {
    		return $this->delete($this->table,array('tire_desired_id'=>$id));
    	}
    }
    ...
    public function getAllTireByWhere($id){
        return $this->query('SELECT * FROM tire_desired WHERE tire_desired_id != '.$id);
    }
