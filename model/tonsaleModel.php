...
Class tonsaleModel Extends baseModel {
	protected $table = "ton_sale";
    ...
    public function deleteSale($id){
    	if ($this->getSale($id)) {
    		return $this->delete($this->table,array('ton_sale_id'=>$id));
    	}
    }
    ...
    public function getAllSaleByWhere($id){
        return $this->query('SELECT * FROM ton_sale WHERE ton_sale_id != '.$id);
    }
