...
Class tiresalecostModel Extends baseModel {
	protected $table = "tire_sale_cost";
    ...
    public function deleteTire($id){
    	if ($this->getTire($id)) {
    		return $this->delete($this->table,array('tire_sale_cost_id'=>$id));
    	}
    }
    ...
    public function getAllTireByWhere($id){
        return $this->query('SELECT * FROM tire_sale_cost WHERE tire_sale_cost_id != '.$id);
    }
