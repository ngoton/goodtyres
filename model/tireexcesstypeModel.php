...
Class tireexcesstypeModel Extends baseModel {
	protected $table = "tire_excess_type";
    ...
    public function deleteTire($id){
    	if ($this->getTire($id)) {
    		return $this->delete($this->table,array('tire_excess_type_id'=>$id));
    	}
    }
    ...
    public function getAllTireByWhere($id){
        return $this->query('SELECT * FROM tire_excess WHERE tire_excess_type_id != '.$id);
    }
