...
Class tirebrandgroupModel Extends baseModel {
	protected $table = "tire_brand_group";
    ...
    public function deleteTire($id){
    	if ($this->getTire($id)) {
    		return $this->delete($this->table,array('tire_brand_group_id'=>$id));
    	}
    }
    ...
    public function getAllTireByWhere($id){
        return $this->query('SELECT * FROM tire_brand_group WHERE tire_brand_group_id != '.$id);
    }
