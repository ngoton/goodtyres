...
Class workupdateModel Extends baseModel {
	protected $table = "work_update";
    ...
    public function deleteWork($id){
    	if ($this->getWork($id)) {
    		return $this->delete($this->table,array('work_update_id'=>$id));
    	}
    }
    ...
    public function getAllWorkByWhere($id){
        return $this->query('SELECT * FROM work_update WHERE work_update_id != '.$id);
    }
