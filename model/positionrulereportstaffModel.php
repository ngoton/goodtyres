...
Class positionrulereportstaffModel Extends baseModel {
	protected $table = "position_rule_report_staff";
    ...
    public function deleteSalary($id){
    	if ($this->getSalary($id)) {
    		return $this->delete($this->table,array('position_rule_report_staff_id'=>$id));
    	}
    }
