...
Class seccostModel Extends baseModel {
	protected $table = "sec_cost";
    ...
    public function deleteCosts($id){
    	if ($this->getCosts($id)) {
    		return $this->delete($this->table,array('sec_cost_id'=>$id));
    	}
    }
    ...
    public function getAllCostsByWhere($id){
        return $this->query('SELECT * FROM sec_cost WHERE sec_cost_id != '.$id);
    }
