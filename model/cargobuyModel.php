...
Class cargobuyModel Extends baseModel {
	protected $table = "cargo_buy";
    ...
    public function deleteCargo($id){
    	if ($this->getCargo($id)) {
    		return $this->delete($this->table,array('cargo_buy_id'=>$id));
    	}
    }
    ...
    public function getAllCargoByWhere($id){
        return $this->query('SELECT * FROM cargo_buy WHERE cargo_buy_id != '.$id);
    }
