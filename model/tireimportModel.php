...
Class tireimportModel Extends baseModel {
	protected $table = "tire_import";
    ...
    public function deleteTire($id){
    	if ($this->getTire($id)) {
    		return $this->delete($this->table,array('tire_import_id'=>$id));
    	}
    }
    ...
    public function getAllTireByWhere($id){
        return $this->query('SELECT * FROM tire_import WHERE tire_import_id != '.$id);
    }
