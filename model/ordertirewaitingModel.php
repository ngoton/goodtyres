...
Class ordertirewaitingModel Extends baseModel {
	protected $table = "order_tire_waiting";
    ...
    public function deleteTire($id){
    	if ($this->getTire($id)) {
    		return $this->delete($this->table,array('order_tire_waiting_id'=>$id));
    	}
    }
    ...
    public function getAllTireByWhere($id){
        return $this->query('SELECT * FROM order_tire_waiting WHERE order_tire_waiting_id != '.$id);
    }
