...
Class workplandetailModel Extends baseModel {
	protected $table = "work_plan_detail";
    ...
    public function deleteWork($id){
    	if ($this->getWork($id)) {
    		return $this->delete($this->table,array('work_plan_detail_id'=>$id));
    	}
    }
    ...
    public function getAllWorkByWhere($id){
        return $this->query('SELECT * FROM work_plan_detail WHERE work_plan_detail_id != '.$id);
    }
