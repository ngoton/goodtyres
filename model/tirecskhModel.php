...
Class tirecskhModel Extends baseModel {
	protected $table = "tire_cskh";
    ...
    public function deleteTire($id){
    	if ($this->getTire($id)) {
    		return $this->delete($this->table,array('tire_cskh_id'=>$id));
    	}
    }
    ...
    public function getAllTireByWhere($id){
        return $this->query('SELECT * FROM tire_cskh WHERE tire_cskh_id != '.$id);
    }
