...
Class eventrunModel Extends baseModel {
	protected $table = "event_run";
    ...
    public function deleteEvent($id){
    	if ($this->getEvent($id)) {
    		return $this->delete($this->table,array('event_run_id'=>$id));
    	}
    }
    ...
    public function getAllEventByWhere($id){
        return $this->query('SELECT * FROM event_run WHERE event_run_id != '.$id);
    }
