...
Class agentvendorModel Extends baseModel {
    ...
    public function deleteVendor($id){
    	if ($this->getVendor($id)) {
    		return $this->delete($this->table,array('agent_vendor_id'=>$id));
    	}
    }
    ...
    public function getAllVendorByWhere($id){
        return $this->query('SELECT * FROM agent_vendor WHERE agent_vendor_id != '.$id);
    }
