...
Class manifestsaleModel Extends baseModel {
	protected $table = "manifest_sale";
    ...
    public function deleteSale($id){
    	if ($this->getSale($id)) {
    		return $this->delete($this->table,array('manifest_sale_id'=>$id));
    	}
    }
    ...
    public function getAllSaleByWhere($id){
        return $this->query('SELECT * FROM manifest_sale WHERE manifest_sale_id != '.$id);
    }
