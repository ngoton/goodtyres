...
Class tireordersaletypeModel Extends baseModel {
	protected $table = "tire_order_sale_type";
    ...
    public function deleteTire($id){
    	if ($this->getTire($id)) {
    		return $this->delete($this->table,array('tire_order_sale_type_id'=>$id));
    	}
    }
    ...
    public function getAllTireByWhere($id){
        return $this->query('SELECT * FROM tire_order_sale_type WHERE tire_order_sale_type_id != '.$id);
    }
