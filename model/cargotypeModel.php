...
Class cargotypeModel Extends baseModel {
    ...
    public function deleteCargo($id){
    	if ($this->getCargo($id)) {
    		return $this->delete($this->table,array('cargo_type_id'=>$id));
    	}
    }
    ...
    public function getAllCargoByWhere($id){
        return $this->query('SELECT * FROM cargo_type WHERE cargo_type_id != '.$id);
    }
