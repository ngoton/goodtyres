...
Class tirecostlogsModel Extends baseModel {
	protected $table = "tire_cost_logs";
    ...
    public function deleteTire($id){
    	if ($this->getTire($id)) {
    		return $this->delete($this->table,array('tire_cost_logs_id'=>$id));
    	}
    }
    ...
    public function getAllTireByWhere($id){
        return $this->query('SELECT * FROM tire_cost_logs WHERE tire_cost_logs_id != '.$id);
    }
