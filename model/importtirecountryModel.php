...
Class importtirecountryModel Extends baseModel {
	protected $table = "import_tire_country";
    ...
    public function deleteImport($id){
    	if ($this->getImport($id)) {
    		return $this->delete($this->table,array('import_tire_country_id'=>$id));
    	}
    }
    ...
    public function getAllImportByWhere($id){
        return $this->query('SELECT * FROM import_tire_country WHERE import_tire_country_id != '.$id);
    }
