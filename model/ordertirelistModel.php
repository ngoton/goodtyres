...
Class ordertirelistModel Extends baseModel {
	protected $table = "order_tire_list";
    ...
    public function deleteTire($id){
    	if ($this->getTire($id)) {
    		return $this->delete($this->table,array('order_tire_list_id'=>$id));
    	}
    }
    ...
    public function getAllTireByWhere($id){
        return $this->query('SELECT * FROM order_tire_list WHERE order_tire_list_id != '.$id);
    }
