...
Class ecartlistModel Extends baseModel {
	protected $table = "e_cart_list";
    ...
    public function deleteCart($id){
    	if ($this->getCart($id)) {
    		return $this->delete($this->table,array('e_cart_list_id'=>$id));
    	}
    }
    ...
    public function getAllCartByWhere($id){
        return $this->query('SELECT * FROM e_cart_list WHERE e_cart_list_id != '.$id);
    }
