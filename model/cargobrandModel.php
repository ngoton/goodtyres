...
Class cargobrandModel Extends baseModel {
	protected $table = "cargo_brand";
    ...
    public function deleteCargo($id){
    	if ($this->getCargo($id)) {
    		return $this->delete($this->table,array('cargo_brand_id'=>$id));
    	}
    }
    ...
    public function getAllCargoByWhere($id){
        return $this->query('SELECT * FROM cargo_brand WHERE cargo_brand_id != '.$id);
    }
