...
Class salevendorModel Extends baseModel {
	protected $table = "sale_vendor";
    ...
    public function deleteVendor($id){
    	if ($this->getVendor($id)) {
    		return $this->delete($this->table,array('sale_vendor_id'=>$id));
    	}
    }
    ...
    public function getAllVendorByWhere($id){
        return $this->query('SELECT * FROM sale_vendor WHERE sale_vendor_id != '.$id);
    }
