...
Class tirequotationModel Extends baseModel {
	protected $table = "tire_quotation";
    ...
    public function deleteTire($id){
    	if ($this->getTire($id)) {
    		return $this->delete($this->table,array('tire_quotation_id'=>$id));
    	}
    }
    ...
    public function getAllTireByWhere($id){
        return $this->query('SELECT * FROM tire_quotation WHERE tire_quotation_id != '.$id);
    }
