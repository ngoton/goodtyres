...
Class tirepriceModel Extends baseModel {
	protected $table = "tire_price";
    ...
    public function deleteTire($id){
    	if ($this->getTire($id)) {
    		return $this->delete($this->table,array('tire_price_id'=>$id));
    	}
    }
    ...
    public function getAllTireByWhere($id){
        return $this->query('SELECT * FROM tire_price WHERE tire_price_id != '.$id);
    }
