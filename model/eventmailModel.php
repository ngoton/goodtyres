...
Class eventmailModel Extends baseModel {
	protected $table = "event_mail";
    ...
    public function deleteEvent($id){
    	if ($this->getEvent($id)) {
    		return $this->delete($this->table,array('event_mail_id'=>$id));
    	}
    }
    ...
    public function getAllEventByWhere($id){
        return $this->query('SELECT * FROM event_mail WHERE event_mail_id != '.$id);
    }
