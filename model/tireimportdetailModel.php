...
Class tireimportdetailModel Extends baseModel {
	protected $table = "tire_import_detail";
    ...
    public function deleteTire($id){
    	if ($this->getTire($id)) {
    		return $this->delete($this->table,array('tire_import_detail_id'=>$id));
    	}
    }
    ...
    public function getAllTireByWhere($id){
        return $this->query('SELECT * FROM tire_import_detail WHERE tire_import_detail_id != '.$id);
    }
