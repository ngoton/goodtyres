...
Class customersaleModel Extends baseModel {
    ...
    public function deleteCustomer($id){
    	if ($this->getCustomer($id)) {
    		return $this->delete($this->table,array('customer_sale_id'=>$id));
    	}
    }
    ...
    public function getAllCustomerByWhere($id){
        return $this->query('SELECT * FROM customer_sale WHERE customer_sale_id != '.$id);
    }
