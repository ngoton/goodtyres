...
Class checksalarypercentModel Extends baseModel {
	protected $table = "check_salary_percent";
    ...
    public function deleteSalary($id){
    	if ($this->getSalary($id)) {
    		return $this->delete($this->table,array('check_salary_perent_id'=>$id));
    	}
    }
    ...
    public function getAllSalaryByWhere($id){
        return $this->query('SELECT * FROM check_salary_perent WHERE check_salary_perent_id != '.$id);
    }
