...
Class cargocategoryModel Extends baseModel {
	protected $table = "cargo_category";
    ...
    public function deleteCargo($id){
    	if ($this->getCargo($id)) {
    		return $this->delete($this->table,array('cargo_category_id'=>$id));
    	}
    }
    ...
    public function getAllCargoByWhere($id){
        return $this->query('SELECT * FROM cargo_category WHERE cargo_category_id != '.$id);
    }
