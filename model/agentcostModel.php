...
Class agentcostModel Extends baseModel {
	protected $table = "agent_cost";
    ...
    public function deleteCosts($id){
    	if ($this->getCosts($id)) {
    		return $this->delete($this->table,array('agent_cost_id'=>$id));
    	}
    }
    ...
    public function getAllCostsByWhere($id){
        return $this->query('SELECT * FROM agent_cost WHERE agent_cost_id != '.$id);
    }
