...
Class tireprofitModel Extends baseModel {
	protected $table = "tire_profit";
    ...
    public function deleteTire($id){
    	if ($this->getTire($id)) {
    		return $this->delete($this->table,array('tire_profit_id'=>$id));
    	}
    }
    ...
    public function getAllTireByWhere($id){
        return $this->query('SELECT * FROM tire_profit WHERE tire_profit_id != '.$id);
    }
