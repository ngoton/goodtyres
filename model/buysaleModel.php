...
Class buysaleModel Extends baseModel {
	protected $table = "buy_sale";
    ...
    public function deleteSale($id){
    	if ($this->getSale($id)) {
    		return $this->delete($this->table,array('buy_sale_id'=>$id));
    	}
    }
    ...
    public function getAllSaleByWhere($id){
        return $this->query('SELECT * FROM buy_sale WHERE buy_sale_id != '.$id);
    }
