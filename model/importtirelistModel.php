...
Class importtirelistModel Extends baseModel {
	protected $table = "import_tire_list";
    ...
    public function deleteImport($id){
    	if ($this->getImport($id)) {
    		return $this->delete($this->table,array('import_tire_list_id'=>$id));
    	}
    }
    ...
    public function getAllImportByWhere($id){
        return $this->query('SELECT * FROM import_tire_list WHERE import_tire_list_id != '.$id);
    }
