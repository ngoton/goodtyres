...
Class insurranceModel Extends baseModel {
    ...
    public function deleteSalary($id){
    	if ($this->getSalary($id)) {
    		return $this->delete($this->table,array('insurrance_id'=>$id));
    	}
    }
    ...
    public function getAllSalaryByWhere($id){
        return $this->query('SELECT * FROM insurrance WHERE insurrance_id != '.$id);
    }
