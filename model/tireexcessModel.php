...
Class tireexcessModel Extends baseModel {
	protected $table = "tire_excess";
    ...
    public function deleteTire($id){
    	if ($this->getTire($id)) {
    		return $this->delete($this->table,array('tire_excess_id'=>$id));
    	}
    }
    ...
    public function getAllTireByWhere($id){
        return $this->query('SELECT * FROM tire_excess WHERE tire_excess_id != '.$id);
    }
