...
Class fixedassetsaleModel Extends baseModel {
	protected $table = "fixed_asset_sale";
    ...
    public function deleteAsset($id){
    	if ($this->getAsset($id)) {
    		return $this->delete($this->table,array('fixed_asset_sale_id'=>$id));
    	}
    }
    ...
    public function getAllAssetByWhere($id){
        return $this->query('SELECT * FROM fixed_asset_sale WHERE fixed_asset_sale_id != '.$id);
    }
