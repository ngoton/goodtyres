...
Class pendingcostsModel Extends baseModel {
	protected $table = "pending_costs";
    ...
    public function deleteCosts($id){
    	if ($this->getCosts($id)) {
    		return $this->delete($this->table,array('pending_costs_id'=>$id));
    	}
    }
    ...
    public function getAllCostsByWhere($id){
        return $this->query('SELECT * FROM pending_costs WHERE pending_costs_id != '.$id);
    }
