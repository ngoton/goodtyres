...
Class tirebuypriceModel Extends baseModel {
	protected $table = "tire_buy_price";
    ...
    public function deleteTire($id){
    	if ($this->getTire($id)) {
    		return $this->delete($this->table,array('tire_buy_price_id'=>$id));
    	}
    }
    ...
    public function getAllTireByWhere($id){
        return $this->query('SELECT * FROM tire_buy_price WHERE tire_buy_price_id != '.$id);
    }
