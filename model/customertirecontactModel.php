...
Class customertirecontactModel Extends baseModel {
	protected $table = "customer_tire_contact";
    ...
    public function deleteCustomer($id){
    	if ($this->getCustomer($id)) {
    		return $this->delete($this->table,array('customer_tire_contact_id'=>$id));
    	}
    }
    ...
    public function getAllCustomerByWhere($id){
        return $this->query('SELECT * FROM customer_tire_contact WHERE customer_tire_contact_id != '.$id);
    }
