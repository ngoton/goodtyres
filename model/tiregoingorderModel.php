...
Class tiregoingorderModel Extends baseModel {
	protected $table = "tire_going_order";
    ...
    public function deleteTire($id){
    	if ($this->getTire($id)) {
    		return $this->delete($this->table,array('tire_going_order_id'=>$id));
    	}
    }
    ...
    public function getAllTireByWhere($id){
        return $this->query('SELECT * FROM tire_going_order WHERE tire_going_order_id != '.$id);
    }
